...
// Read JSON file
const jsonPath = path.join(__dirname, 'backend', 'data', 'groundwaterData.json');
const csvPath = path.join(__dirname, 'backend', 'data', 'sample_groundwater.csv');
...
const districts = [...new Set(data.map(w => w.district))];
